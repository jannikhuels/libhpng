...
public class ContinuousPlacesPlotterVar {


	public ContinuousPlacesPlotterVar() {	}
	...
	public void plotContinuousPlaces(HPnGModelVar model, ArrayList<MarkingPlotVar> plots, Double maxTime, Double confidenceLevel){
		...
		for (Place place : model.getPlaces()){			
			if (place.getClass().equals(ContinuousPlaceVar.class)){
				...
				plotMeansAndConfidenceIntervals((ContinuousPlaceVar)place, plots, maxTime, graph, t);
	...
	private void plotMeansAndConfidenceIntervals(ContinuousPlaceVar place, ArrayList<MarkingPlotVar> plots, Double maxTime, XYLineGraph graph, Double t){
