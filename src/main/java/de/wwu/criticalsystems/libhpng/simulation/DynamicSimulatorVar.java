...
public class DynamicSimulatorVar extends SimulatorVar {

    public DynamicSimulatorVar(HPnGModelVar model, Double maxTime, SimulationHandlerVar simulationHandlerVar, ArrayList<FluidPropertyVar> fluidProperties) {
        super(model, maxTime, simulationHandlerVar);
...
//
    ...
    private ArrayList<FluidPropertyVar> fluidProperties;
...
//		ContinuousPlaceVar place = property.getPlace();
